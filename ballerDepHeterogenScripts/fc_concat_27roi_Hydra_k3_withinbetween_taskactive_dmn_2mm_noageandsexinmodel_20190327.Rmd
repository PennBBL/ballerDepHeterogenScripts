---
title: "FC Task active/DMN, matched age and sex, n312, Hydra K3, 27 jneurosci labels, 2mm, no age and sex in lm model"
author: "Erica Baller"
date: "3/28/2019"
output:
...
#Pull p-values
p_anova_lm_agesq <- sapply(network_cluster_stats_anova_lm_agesq_AG_matched, function(v) v$"Pr(>F)"[4]) #$coef[,"Pr(>F)"][2]) #get the p value for dep binarized
