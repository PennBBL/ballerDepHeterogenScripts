---
title: "Functional Connectivity, r200, com17 communities, n 325, Hydra_k3"
author: "Erica Baller"
date: "7/17/18"
output:
...
num_clusters <- 3
res <- 200
filename <- Sys.glob(paste0("/Users/eballer/BBL/from_chead/ballerDepHeterogen/data/output_of_fc/fc_r", res, "_com", num_communities, "/fc_r", res, "_com", num_communities, ".csv"))
...
#all_mean_sd_sem <- data.frame(rep(groups$cl, num_measures), rep(networks, each = total_num_groups), rep(0, 1), rep(0, 1), rep(0,1))
