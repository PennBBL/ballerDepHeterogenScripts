---
title: "Cog hydra matched age, age regressed and z score regressed Hydra k2, "
author: "Erica Baller"
date: "4/2/2018"
output:
...
-There is a test option that does this for all cognitive measures and all hydra groups, but for the remainder of the analysis, Hydra_k2 was the only classification more deeply explored.
...
df_mean_accuracy_z <-c(mean(subset_with_clusters_AG_matched$NAR_Overall_Accuracy[which(subset_with_clusters_AG_matched$Hydra_k2 == -1)]),
                       ...
                       mean(subset_with_clusters_AG_matched$NAR_Overall_Accuracy[which(subset_with_clusters_AG_matched$Hydra_k2 == 3)]))
...
df_mean_processing_speed_z <- c(mean(subset_with_clusters_AG_matched$NAR_Overall_Speed[which(subset_with_clusters_AG_matched$Hydra_k2 == -1)]),
                                ...
                                mean(subset_with_clusters_AG_matched$NAR_Overall_Speed[which(subset_with_clusters_AG_matched$Hydra_k2 == 3)]))
...
df_mean_efficiency_z <- c(mean(subset_with_clusters_AG_matched$NAR_Overall_Efficiency[which(subset_with_clusters_AG_matched$Hydra_k2 == -1)]),
                          ...
                          mean(subset_with_clusters_AG_matched$NAR_Overall_Efficiency[which(subset_with_clusters_AG_matched$Hydra_k2 == 3)]))
...
cnb_data_acc_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2", "Cluster3"), mean_acc = c(mean(subset_with_clusters_AG_matched$NAR_Overall_Accuracy[which(subset_with_clusters_AG_matched$Hydra_k2 ==-1)]),
                                                                                     mean(subset_with_clusters_AG_matched$NAR_Overall_Accuracy[which(subset_with_clusters_AG_matched$Hydra_k2 ==1)]),
                                                                                     mean(subset_with_clusters_AG_matched$NAR_Overall_Accuracy[which(subset_with_clusters_AG_matched$Hydra_k2 ==2)]),
                                                                                     mean(subset_with_clusters_AG_matched$NAR_Overall_Accuracy[which(subset_with_clusters_AG_matched$Hydra_k2 ==3)])),
                                  sd_acc = c(sd(subset_with_clusters_AG_matched$NAR_Overall_Accuracy[which(subset_with_clusters_AG_matched$Hydra_k2 == -1)]),
                                             ...
                                             sd(subset_with_clusters_AG_matched$NAR_Overall_Accuracy[which(subset_with_clusters_AG_matched$Hydra_k2 ==3)])))

cnb_data_speed_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2", "Cluster3"), mean_speed = c(mean(subset_with_clusters_AG_matched$NAR_Overall_Speed[which(subset_with_clusters_AG_matched$Hydra_k2 ==-1)]),
                                                                                         mean(subset_with_clusters_AG_matched$NAR_Overall_Speed[which(subset_with_clusters_AG_matched$Hydra_k2 ==1)]),
                                                                                         mean(subset_with_clusters_AG_matched$NAR_Overall_Speed[which(subset_with_clusters_AG_matched$Hydra_k2 ==2)]),
                                                                                         mean(subset_with_clusters_AG_matched$NAR_Overall_Speed[which(subset_with_clusters_AG_matched$Hydra_k2 ==3)])),
                                    sd_speed = c(sd(subset_with_clusters_AG_matched$NAR_Overall_Speed[which(subset_with_clusters_AG_matched$Hydra_k2 == -1)]),
                                                 ...
                                                 sd(subset_with_clusters_AG_matched$NAR_Overall_Speed[which(subset_with_clusters_AG_matched$Hydra_k2 ==3)])))

cnb_data_eff_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2", "Cluster3"), mean_eff = c(mean(subset_with_clusters_AG_matched$NAR_Overall_Efficiency[which(subset_with_clusters_AG_matched$Hydra_k2 ==-1)]),
                                                                                     mean(subset_with_clusters_AG_matched$NAR_Overall_Efficiency[which(subset_with_clusters_AG_matched$Hydra_k2 ==1)]),
                                                                                     mean(subset_with_clusters_AG_matched$NAR_Overall_Efficiency[which(subset_with_clusters_AG_matched$Hydra_k2 ==2)]),
                                                                                     mean(subset_with_clusters_AG_matched$NAR_Overall_Efficiency[which(subset_with_clusters_AG_matched$Hydra_k2 ==3)])),
                                  sd_eff = c(sd(subset_with_clusters_AG_matched$NAR_Overall_Efficiency[which(subset_with_clusters_AG_matched$Hydra_k2 == -1)]),
                                             ...
                                             sd(subset_with_clusters_AG_matched$NAR_Overall_Efficiency[which(subset_with_clusters_AG_matched$Hydra_k2 ==3)])))
...
ggplot(data = all_mean_sd_sem, aes(x = cnb, y = mean, group = cl)) +  ylab("Mean Z-score") +
  ...
  ggtitle("Hydra_k2, Age regressed and z-score regressed CNB Measures") 
...
#  ggtitle("Hydra_k2 mood") #+ scale_fill_discrete(breaks=c("TD", "Cluster1", "Cluster2", "Cluster3")) +
#  guides(fill=guide_legend(title=NULL))
...
#ggplot(cnb_all_measures, aes(x = cl, y = psychosis, fill=cl)) + geom_col() +
 # scale_x_discrete(limits=c("TD", "Cluster1", "Cluster2", "Cluster3")) + xlab("Clusters") + ylab("psychosis") + 
  #ggtitle("Hydra_k2 psychosis") #+ scale_fill_discrete(breaks=c("TD", "Cluster1", "Cluster2", "Cluster3")) +
# guides(fill=guide_legend(title=NULL))
...
#  ggtitle("Hydra_k2 phobias")# + scale_fill_discrete(breaks=c("TD", "Cluster1", "Cluster2", "Cluster3")) +
#  guides(fill=guide_legend(title=NULL))
...
#  ggtitle("Hydra_k2 externalizing") #+ scale_fill_discrete(breaks=c("TD", "Cluster1", "Cluster2", "Cluster3")) +
## guides(fill=guide_legend(title=NULL))
...
#ggplot(cnb_all_measures, aes(x = cl, y = overall, fill=cl)) + geom_col() +
 # scale_x_discrete(limits=c("TD", "Cluster1", "Cluster2", "Cluster3")) + xlab("Clusters") + ylab("overall") + 
  #ggtitle("Hydra_k2 overall")# + scale_fill_discrete(breaks=c("TD", "Cluster1", "Cluster2", "Cluster3")) +
# guides(fill=guide_legend(title=NULL))
