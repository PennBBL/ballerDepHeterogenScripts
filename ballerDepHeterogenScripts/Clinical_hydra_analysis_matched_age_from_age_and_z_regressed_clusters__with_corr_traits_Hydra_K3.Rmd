---
title: "Clinical_hydra_ age and z regressed, with corr traits"
author: "Erica Baller"
date: "4/9/2018"
output:
...
clinical_measure_names <- names(subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED)[grep("corrtraits", names(subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED))] #get the names of all the columns with _z in the name
...
ggplot(data = all_mean_sd_sem, aes(x = clinical, y = mean, group = cl)) +  ylab("Mean Z-score") +
  ...
  ggtitle("Hydra_k3, Age regressed and z-score regressed clinical Measures- corr traits") 
