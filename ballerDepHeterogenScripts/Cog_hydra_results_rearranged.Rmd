...
#PREPPING DATAn (part 1 and 2) (read in csvs, merge with hydra)
...
Part 5-7: linear model, anova, and FDR correction
```{r stats}
###################################################
...
ggplot(data=cnb_all_measures, aes(x=cl, group=1)) + 
  geom_line(aes(y=acc,color="red")) + 
  geom_line(aes(y=speed,color="blue")) +
  geom_line(aes(y=eff,color="pink")) +
  ylab("z-score") + xlab("cluster") +
  ggtitle("Hydra_k2 CNB Measures")
