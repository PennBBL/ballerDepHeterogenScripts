---
title: "Functional Connectivity with 6 task active regions_concat"
author: "Erica Baller"
date: "4/5/2019"
output:
...
num_clusters = 3
#Make sample
dem_and_cluster_data <- read.csv("/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/df_task_active_node_strength_concat_6roi_concat_20190405.csv")
...
write.csv(all_mean_sd_sem, "/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/fc_task_active_6roi_concat_unsorted.csv")
#plot
...
new_order <- read.csv("/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/fc_task_active_6roi_concat_sorted.csv")
...
averages <- readRDS("/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/rds/averages_6roi_concat_20190405.rds")
td <- averages[[1]]
s1 <- averages[[2]]
s2 <- averages[[3]]
s3 <- averages[[4]]
