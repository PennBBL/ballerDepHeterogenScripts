#This script will do 3dROISTATS to get time series from rest
#Done in 2mm space
#OUTPUT /data/jux/BBL/projects/ballerDepHeterogen/data/neuroimaging/processed_data/rest/rest_2mm/ts_files_from_3dROIstats

set cwdir = `pwd`
set parcels_2mm = `ls /data/jux/BBL/projects/ballerDepHeterogen/data/neuroimaging/nback/parcels/frac2back_n951_parametric_27roi_thr20_2mm.nii`
set wkdir = "/data/jux/BBL/projects/ballerDepHeterogen/data/neuroimaging/processed_data/rest/rest_2mm/"
set outdir = "/data/jux/BBL/projects/ballerDepHeterogen/data/neuroimaging/processed_data/rest/rest_2mm/ts_files_from_3dROIstats"
