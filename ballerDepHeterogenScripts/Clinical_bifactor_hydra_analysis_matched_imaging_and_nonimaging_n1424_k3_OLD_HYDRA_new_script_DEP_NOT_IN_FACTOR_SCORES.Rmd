---
title: "Clinical_bifactor_hydra_analysis_matched_imaging_and_non_imaging_n1424_k3, regressed_on_age_and_sex, BIFACTOR SCORES, old hydra, new script - Depression NOT in bifactor scores"
author: "Erica Baller"
date: "1/16/2019"
output:
...
clinical_measure_names_list <- names(subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED)[grep("Bifactor", names(subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED))]  #get the names of all the columns with factorv2 in the name
