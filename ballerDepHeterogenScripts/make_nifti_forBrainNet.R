...
fvals <- read.csv("/data/jux/BBL/projects/ballerDepHeterogen/results/csvs/nback_f_fdr_corr0s_forBrainNet.csv", header = FALSE)
...
writeNifti(newNifti, "/data/jux/BBL/projects/ballerDepHeterogen/data/neuroimaging/nback/parcels/nifti_fvals_for_fdr_corrected_ps_roi27_thresh20_2mm.nii.gz")