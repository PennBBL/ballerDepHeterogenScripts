...
#lm
CT_cog_score_cluster_stats_lm_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  CT_cog_score_cluster_stats_lm_AG_matched_withincluster<- lapply(CT_measure_names_list, cluster=as.name(cluster_name), function(CT_measure_name, cluster) 
  {
  ...
  setNames(CT_cog_score_cluster_stats_lm_AG_matched_withincluster, CT_measure_names_list)
})
names(CT_cog_score_cluster_stats_lm_AG_matched_by_cluster_1through10) <- cluster_names_list

#gam
CT_cog_score_cluster_stats_gam_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
 CT_cog_score_cluster_stats_gam_AG_matched_withincluster<- lapply(CT_measure_names_list, cluster=as.name(cluster_name),   function(CT_measure_name, cluster) 
 {
    CT_measure <- as.name(CT_measure_name)
 ...
 setNames(CT_cog_score_cluster_stats_gam_AG_matched_withincluster, CT_measure_names_list)
})
names(CT_cog_score_cluster_stats_gam_AG_matched_by_cluster_1through10) <- cluster_names_list

#LM with mean-centered, squared age- quadratic term#

CT_cog_score_cluster_stats_lm_agesq_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  CT_cog_score_cluster_stats_lm_agesq_AG_matched_withincluster<- lapply(CT_measure_names_list, cluster=as.name(cluster_name), function(CT_measure_name, cluster) 
  {
    CT_measure <- as.name(CT_measure_name)
  ...
  setNames(CT_cog_score_cluster_stats_lm_agesq_AG_matched_withincluster, CT_measure_names_list)
})
names(CT_cog_score_cluster_stats_lm_agesq_AG_matched_by_cluster_1through10) <- cluster_names_list


##### Just Hydra_3 clusters ######
#lm
CT_cog_score_cluster_stats_lm_AG_matched <- lapply(CT_measure_names, function(x) 
{
  lm(substitute(i ~ Hydra_k3, list(i = as.name(x))), data = subset_with_clusters_AG_matched)
})
names(CT_cog_score_cluster_stats_lm_AG_matched) <- CT_measure_names

#gam
CT_cog_score_cluster_stats_gam_AG_matched <- lapply(CT_measure_names, function(x) 
{
...
names(CT_cog_score_cluster_stats_gam_AG_matched) <- CT_measure_names

#lm ageSq and mean centered
CT_cog_score_cluster_stats_lm_agesq_AG_matched <- lapply(CT_measure_names, function(x) 
{
  lm(substitute(i ~ Hydra_k3 + sex + ageSq + averageManualRating, list(i = as.name(x))), data = subset_with_clusters_AG_matched)
})
names(CT_cog_score_cluster_stats_lm_agesq_AG_matched) <- CT_measure_names
##############################
####### Statistics ###########
##############################
...
CT_cog_score_cluster_stats_anova_lm_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  CT_cog_score_cluster_stats_anova_AG_withincluster <- lapply(CT_measure_names_list, cluster=as.name(cluster_name), function(CT_measure_name, cluster) 
  {
     CT_measure <- as.name(CT_measure_name)
     anova(lm(substitute(CT_measure ~ cluster, list(CT_measure = CT_measure, cluster = cluster)), data = subset_with_clusters_AG_matched))
  })
  setNames(CT_cog_score_cluster_stats_anova_AG_withincluster, CT_measure_names_list)
})
names(CT_cog_score_cluster_stats_anova_lm_AG_matched_by_cluster_1through10) <- cluster_names_list

#gam anova all clusters
CT_cog_score_cluster_stats_anova_gam_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  CT_cog_score_cluster_stats_anova_gam_AG_withincluster <- lapply(CT_measure_names_list, cluster=as.name(cluster_name), function(CT_measure_name, cluster) 
  {
     CT_measure <- as.name(CT_measure_name)
  ...
  setNames(CT_cog_score_cluster_stats_anova_gam_AG_withincluster, CT_measure_names_list)
})
names(CT_cog_score_cluster_stats_anova_gam_AG_matched_by_cluster_1through10) <- cluster_names_list

#lm agesq anova all clusters
CT_cog_score_cluster_stats_anova_lm_agesq_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  CT_cog_score_cluster_stats_anova_lm_agesq_AG_withincluster <- lapply(CT_measure_names_list, cluster=as.name(cluster_name), function(CT_measure_name, cluster) 
  {
     CT_measure <- as.name(CT_measure_name)
  ...
  setNames(CT_cog_score_cluster_stats_anova_lm_agesq_AG_withincluster, CT_measure_names_list)
})
names(CT_cog_score_cluster_stats_anova_lm_agesq_AG_matched_by_cluster_1through10) <- cluster_names_list


#####Just Hydra 3 clusters ANOVA ########
#lm Hydra K3 Anova
CT_cog_score_cluster_stats_anova_lm_AG_matched <- lapply(CT_cog_score_cluster_stats_lm_AG_matched, anova) 
names(CT_cog_score_cluster_stats_anova_lm_AG_matched) <- CT_measure_names

#gam Hydra K3 ANOVA
CT_cog_score_cluster_stats_anova_gam_AG_matched <- lapply(CT_cog_score_cluster_stats_gam_AG_matched, anova)
names(CT_cog_score_cluster_stats_anova_gam_AG_matched) <- CT_measure_names

#####Just Hydra 3 clusters ANOVA ########
#lm Hydra K3 Anova
CT_cog_score_cluster_stats_anova_lm_agesq_AG_matched <- lapply(CT_cog_score_cluster_stats_lm_agesq_AG_matched, anova) 
names(CT_cog_score_cluster_stats_anova_lm_agesq_AG_matched) <- CT_measure_names
...
models_anova <- lapply(CT_cog_score_cluster_stats_anova_lm_AG_matched, summary)

#Pull p-values
p_anova <- sapply(CT_cog_score_cluster_stats_anova_lm_AG_matched, function(v) v$"Pr(>F)"[1]) #$coef[,"Pr(>F)"][2]) #get the p value for dep binarized
...
#Looking at Hydra_k3, but can redo with nested list
#Look at model summaries
#models_anova <- lapply(CT_cog_score_cluster_stats_anova_gam_AG_matched, summary)

#Pull p-values
p_anova <- sapply(CT_cog_score_cluster_stats_anova_gam_AG_matched, function(v) v$pTerms.table[1,3])
...
#Looking at Hydra_k3
#Look at model summaries
models_anova_lm_agesq <- lapply(CT_cog_score_cluster_stats_anova_lm_agesq_AG_matched, summary)

#Pull p-values
p_anova_lm_agesq <- sapply(CT_cog_score_cluster_stats_anova_lm_agesq_AG_matched, function(v) v$"Pr(>F)"[1]) #$coef[,"Pr(>F)"][2]) #get the p value for dep binarized
...
CT_emmodel_lm_agesq_AG_matched <- lapply(CT_cog_score_cluster_stats_lm_agesq_AG_matched, function(x) {as.list(ref_grid(x))})
...
#########################################################
invisible(lapply(CT_cog_score_cluster_stats_lm_AG_matched, function(x) {visreg(x)}))
