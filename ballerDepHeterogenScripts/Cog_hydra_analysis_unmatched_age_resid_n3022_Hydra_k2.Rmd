---
title: "Cognitive data hydra results unmatched age residualized n3022, Hydra K2"
author: "Erica Baller"
date: "4/23/2018"
output:
...
Part 2 : merge with hydra
  ...
  -The script reads in 3 different types of groups (unmatched_resid)
...
Part 7 : Demographics tables
  - Demographics tables unmatched_resid
...
hydra_AG_unmatched_resid_clusters <- read.csv("/Users/eballer/BBL/from_chead/ballerDepHeterogen/hydra_output_from_cbica/hydra_unmatched/residualized/age_only_n3022/CogData_all_gender_unmatched_resid_n3022_age_FOR_2x2_HydraSubtypes.csv", header = TRUE, sep = ",")

#Coerce hydra values into factor format
hydra_names <- names(hydra_AG_unmatched_resid_clusters[2:11])
hydra_AG_unmatched_resid_clusters[hydra_names] <- lapply(hydra_AG_unmatched_resid_clusters[hydra_names], factor)
...
#AG Unmatched resid - n 3022

subset_with_clusters_AG_unmatched_resid <- merge(subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED, hydra_AG_unmatched_resid_clusters, by = "bblid")
...
#######unmatched_resid group all clusters ##############
#subset demographics
listVars <- c("Race", "Sex", "Maternal Ed", "Age", "Depression", "Cluster") #Race 1 = caucasian, Maternal Ed = years, age = years, dep 1 = dep, 0 = non_dep
demo_Hydra_k2_AG_unmatched_resid <- data.frame(subset_with_clusters_AG_unmatched_resid$race_binarized, subset_with_clusters_AG_unmatched_resid$sex, subset_with_clusters_AG_unmatched_resid$medu1, subset_with_clusters_AG_unmatched_resid$age_in_years, subset_with_clusters_AG_unmatched_resid$dep_binarized, subset_with_clusters_AG_unmatched_resid$Hydra_k2)
names(demo_Hydra_k2_AG_unmatched_resid) <- c(listVars)

#Change categorical values to have names
demo_Hydra_k2_AG_unmatched_resid$Depression <- ifelse(demo_Hydra_k2_AG_unmatched_resid$Depression == 1, "Depressed", "Non-depressed")
demo_Hydra_k2_AG_unmatched_resid$Race <- ifelse(demo_Hydra_k2_AG_unmatched_resid$Race == 1, "Caucasian", "Non-caucasian")
demo_Hydra_k2_AG_unmatched_resid$Sex <- ifelse(demo_Hydra_k2_AG_unmatched_resid$Sex == 1, "Male", "Female")
...
demo_Hydra_k2_AG_unmatched_resid_table <- CreateTableOne(vars = listVars, data = demo_Hydra_k2_AG_unmatched_resid, factorVars = cat_variables, strata = c("Cluster"))
print(demo_Hydra_k2_AG_unmatched_resid_table, showAllLevels = TRUE)
...
cluster_names <- colnames(hydra_AG_unmatched_resid_clusters[,2:11])
...
cluster_names_list <- colnames(hydra_AG_unmatched_resid_clusters[,2:11])

#### All Hydra clusters in embedded lis t######
CNB_cog_score_cluster_stats_lm_AG_unmatched_resid_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  CNB_cog_score_cluster_stats_lm_AG_unmatched_resid_withincluster<- lapply(cnb_measure_names_list, cluster=as.name(cluster_name), function(cnb_measure_name, cluster) 
  {
    cnb_measure <- as.name(cnb_measure_name)
    lm(substitute(cnb_measure ~ cluster, list(cnb_measure = cnb_measure, cluster = cluster)), data = subset_with_clusters_AG_unmatched_resid)
  })
  setNames(CNB_cog_score_cluster_stats_lm_AG_unmatched_resid_withincluster, cnb_measure_names_list)
})
names(CNB_cog_score_cluster_stats_lm_AG_unmatched_resid_by_cluster_1through10) <- cluster_names_list

##### Just Hydra_3 clusters ######
CNB_cog_score_cluster_stats_lm_AG_unmatched_resid <- lapply(cnb_measure_names, function(x) 
{
  lm(substitute(i ~ Hydra_k2, list(i = as.name(x))), data = subset_with_clusters_AG_unmatched_resid)
})
...
CNB_cog_score_cluster_stats_anova_AG_unmatched_resid_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  ...
  {
     cnb_measure <- as.name(cnb_measure_name)
     anova(lm(substitute(cnb_measure ~ cluster, list(cnb_measure = cnb_measure, cluster = cluster)), data = subset_with_clusters_AG_unmatched_resid))
  })
  setNames(CNB_cog_score_cluster_stats_anova_AG_withincluster, cnb_measure_names_list)
})
names(CNB_cog_score_cluster_stats_anova_AG_unmatched_resid_by_cluster_1through10) <- cluster_names_list


#####Just Hydra 2 clusters ANOVA ########
CNB_cog_score_cluster_stats_anova_AG_unmatched_resid <- lapply(cnb_measure_names, function(x) 
{
  anova(lm(substitute(i ~ Hydra_k2, list(i = as.name(x))), data = subset_with_clusters_AG_unmatched_resid))
})



names(CNB_cog_score_cluster_stats_lm_AG_unmatched_resid) <- cnb_measure_names
names(CNB_cog_score_cluster_stats_anova_AG_unmatched_resid) <- cnb_measure_names
...
###chisq_unmatched_resid_sex <- chisq.test(subset_with_clusters_AG_unmatched_resid$sex, (subset_with_clusters_AG_unmatched_resid$Hydra_k2 != -1))
chisq_unmatched_resid_sex <- chisq.test(subset_with_clusters_AG_unmatched_resid$sex, subset_with_clusters_AG_unmatched_resid$Hydra_k2)
chisq_unmatched_resid_sex_pvalue <- chisq_unmatched_resid_sex$p.value
total_people_Hydra_k2 <- c(length(subset_with_clusters_AG_unmatched_resid$sex[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == -1)]), 
                           length(subset_with_clusters_AG_unmatched_resid$sex[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 1)]), 
                           length(subset_with_clusters_AG_unmatched_resid$sex[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 2)])) 
                           

num_men_all_clusters <- c(length(subset_with_clusters_AG_unmatched_resid$sex[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == -1 & subset_with_clusters_AG_unmatched_resid$sex == 1)]), 
                          length(subset_with_clusters_AG_unmatched_resid$sex[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 1 & subset_with_clusters_AG_unmatched_resid$sex == 1)]), 
                          length(subset_with_clusters_AG_unmatched_resid$sex[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 2 & subset_with_clusters_AG_unmatched_resid$sex == 1)])) 
                        
percent_men_all_clusters <- (num_men_all_clusters/total_people_Hydra_k2) * 100


#Chi square race - p-value = ***
chisq_unmatched_resid_race <- chisq.test(subset_with_clusters_AG_unmatched_resid$race_binarized, subset_with_clusters_AG_unmatched_resid$Hydra_k2)
chisq_unmatched_resid_race_pvalue <- chisq_unmatched_resid_race$p.value
num_caucasian_all_clusters <- c(length(subset_with_clusters_AG_unmatched_resid$race_binarized[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == -1 & subset_with_clusters_AG_unmatched_resid$race_binarized == 1)]), 
                                length(subset_with_clusters_AG_unmatched_resid$race_binarized[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 1 & subset_with_clusters_AG_unmatched_resid$race_binarized == 1)]), 
                                length(subset_with_clusters_AG_unmatched_resid$race_binarized[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 2 & subset_with_clusters_AG_unmatched_resid$race_binarized == 1)])) 
                               
percent_caucasian_all_clusters <- (num_caucasian_all_clusters/total_people_Hydra_k2)*100

p_values <- c("", chisq_unmatched_resid_sex_pvalue, "", chisq_unmatched_resid_race_pvalue)
dat_sex_race <- data.frame(cl = c("TD", "Cluster1", "Cluster2", "Significance"), 
                           num_males = c(num_men_all_clusters, "---"),
                           percent_males = round(c(percent_men_all_clusters, chisq_unmatched_resid_sex_pvalue), 2), 
                           num_caucasians = c(num_caucasian_all_clusters, "---"),
                           percent_caucasian = round(c(percent_caucasian_all_clusters, chisq_unmatched_resid_race_pvalue),2))
...
dat <- data.frame(cluster=c(subset_with_clusters_AG_unmatched_resid$Hydra_k2), age=c(subset_with_clusters_AG_unmatched_resid$age_in_years), medu1=c(subset_with_clusters_AG_unmatched_resid$medu1), race=c(subset_with_clusters_AG_unmatched_resid$race_binarized), sex_males=c(subset_with_clusters_AG_unmatched_resid$sex))

dat_age_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2"), 
                             age = c(mean(subset_with_clusters_AG_unmatched_resid$age_in_years[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==-1)]), 
                                     mean(subset_with_clusters_AG_unmatched_resid$age_in_years[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==1)]), 
                                     mean(subset_with_clusters_AG_unmatched_resid$age_in_years[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==2)])), 
                             age_sd = c(sd(subset_with_clusters_AG_unmatched_resid$age_in_years[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==-1)]),
                                        sd(subset_with_clusters_AG_unmatched_resid$age_in_years[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==1)]), 
                                        sd(subset_with_clusters_AG_unmatched_resid$age_in_years[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==2)])))

dat_age_sd_sem$sem <- dat_age_sd_sem$age_sd/sqrt(nrow(dat)) 
#Had to take out people without medu , n for medu group + 2998: this just affects the demographic stats, chi square for medu, not the actual hydra data
subset_people_with_medu <- subset_with_clusters_AG_unmatched_resid[!is.na(subset_with_clusters_AG_unmatched_resid$medu1),]
dat_medu_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2"), 
                              medu = c(mean(subset_people_with_medu$medu1[which(subset_people_with_medu$Hydra_k2 ==-1)]),
                                       mean(subset_people_with_medu$medu1[which(subset_people_with_medu$Hydra_k2 ==1)]), 
                                       mean(subset_people_with_medu$medu1[which(subset_people_with_medu$Hydra_k2 ==2)])), 
                              age_sd = c(sd(subset_people_with_medu$medu1[which(subset_people_with_medu$Hydra_k2 ==-1)]), 
                                         sd(subset_people_with_medu$medu1[which(subset_people_with_medu$Hydra_k2 ==1)]), 
                                         sd(subset_people_with_medu$medu1[which(subset_people_with_medu$Hydra_k2 ==2)]))) 
...
df_mean_accuracy_z <-c(mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == -1)]),
                       mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 1)]),
                       mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 2)]))
                       

df_mean_processing_speed_z <- c(mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == -1)]),
                                mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 1)]),
                                mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 2)]))
                               

df_mean_efficiency_z <- c(mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == -1)]),
                          mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 1)]),
                          mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == 2)]))
...
cnb_data_acc_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2"), mean_acc = c(mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==-1)]),
                                                                                     mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==1)]),
                                                                                     mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==2)])),
                                  sd_acc = c(sd(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == -1)]),
                                             sd(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==1)]),
                                             sd(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==2)])))

cnb_data_speed_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2"), mean_speed = c(mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==-1)]),
                                                                                         mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==1)]),
                                                                                         mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==2)])),
                                    sd_speed = c(sd(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == -1)]),
                                                 sd(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==1)]),
                                                 sd(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==2)])))

cnb_data_eff_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2"), mean_eff = c(mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==-1)]),
                                                                                     mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==1)]),
                                                                                     mean(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==2)])),
                                  sd_eff = c(sd(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == -1)]),
                                             sd(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==1)]),
                                             sd(subset_with_clusters_AG_unmatched_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 ==2)])))


cnb_data_acc_sd_sem$sem = cnb_data_acc_sd_sem$sd_acc/sqrt(nrow(subset_with_clusters_AG_unmatched_resid))
cnb_data_speed_sd_sem$sem = cnb_data_speed_sd_sem$sd_speed/sqrt(nrow(subset_with_clusters_AG_unmatched_resid))
cnb_data_eff_sd_sem$sem = cnb_data_eff_sd_sem$sd_eff/sqrt(nrow(subset_with_clusters_AG_unmatched_resid))
...
###### By CNB Measure ###############
#####################################
#can do with all gender as well, as well as unmatched_resid/ununmatched_resid, etc
...
for(cnb in cnb_measure_names_list){
  for(num in 1:3) {
    ...
    mean_for_eval <- paste("mean(subset_with_clusters_AG_unmatched_resid$", cnb, "[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == ", groups_list[num,2], ")])", sep="")
    ...
    sd_for_eval <- paste("sd(subset_with_clusters_AG_unmatched_resid$", cnb, "[which(subset_with_clusters_AG_unmatched_resid$Hydra_k2 == ", groups_list[num,2], ")])", sep="")
    ...
    all_mean_sd_sem$sem[which(all_mean_sd_sem$cl == clst & all_mean_sd_sem$cnb == cnb)] <- all_mean_sd_sem$sd[which(all_mean_sd_sem$cl == clst & all_mean_sd_sem$cnb == cnb)]/sqrt(nrow(subset_with_clusters_AG_unmatched_resid))
  }
}
...
models_anova <- lapply(CNB_cog_score_cluster_stats_anova_AG_unmatched_resid, summary)

#Pull p-values
p_anova <- sapply(CNB_cog_score_cluster_stats_anova_AG_unmatched_resid, function(v) v$"Pr(>F)"[1]) #$coef[,"Pr(>F)"][2]) #get the p value for dep binarized
...
invisible(lapply(CNB_cog_score_cluster_stats_lm_AG_unmatched_resid, function(x) {visreg(x)}))
