---
title: "Nback Activation, matched age and sex, n368, Hydra K3, 27 jneurosci labels, NEWLY extracted as of 11/21"
author: "Erica Baller"
date: "11/21/2018"
output:
...
nback_new_jneurosci_vals <- read.table("/Users/eballer/BBL/from_chead/ballerDepHeterogen/data/neuroimaging/nback/parcels/mean_activation_by_27roi_by_SCANID.csv", header = TRUE)
...
#preprocessing
#remove the nback factor parcellations- will be adding the ones from the new extraction 
nback_factors_without_parcellations <- nback_Factors[, !(names(nback_Factors) %in% parcellations)]
subset_with_clusters_AG_matched <- merge(dem_and_cluster_data, nback_new_jneurosci_vals, by="scanid")


#subset nback_Factors because it is so big
#nback_Factors_bblid_and_parcellations <-  merge(nback_factors_without_parcellations, new_jneurosci_vals_plus_dem_and_cluster_data, by="bblid")
