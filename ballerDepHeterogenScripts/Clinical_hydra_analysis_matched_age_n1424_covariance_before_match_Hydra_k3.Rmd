---
title: "Cognitive data hydra results matched age n1424, covariance before match, Hydra k3"
author: "Erica Baller"
date: "4/23/2018"
output:
...
hydra_AG_matched_clusters <- read.csv("/Users/eballer/BBL/from_chead/ballerDepHeterogen/hydra_output_from_cbica/hydra_matched/covaried_before_match/CogData_matched_age_n1424_covaried_before_match_HydraSubtypes.csv", header = TRUE, sep = ",")
...
models_anova <- lapply(clinical_score_cluster_stats_anova_AG_matched, summary)

#Pull p-values
p_anova <- sapply(clinical_score_cluster_stats_anova_AG_matched, function(v) v$"Pr(>F)"[1]) #$coef[,"Pr(>F)"][2]) #get the p value for dep binarized
