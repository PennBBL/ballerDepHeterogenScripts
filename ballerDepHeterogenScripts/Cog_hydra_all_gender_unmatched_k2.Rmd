...
for(cnb in cnb_measure_names_list){
  for(num in 1:3) {
    ...
    mean_for_eval <- paste("mean(subset_with_clusters_AG_unmatched$", cnb, "[which(subset_with_clusters_AG_unmatched$Hydra_k2 == ", groups_list[num,2], ")])", sep="")
    ...
    sd_for_eval <- paste("sd(subset_with_clusters_AG_unmatched$", cnb, "[which(subset_with_clusters_AG_unmatched$Hydra_k2 == ", groups_list[num,2], ")])", sep="")
   ...
   # all_mean_sd_sem$sem[which(all_mean_sd_sem$cl == clst & all_mean_sd_sem$cnb == cnb)] <- all_mean_sd_sem$sd[which(all_mean_sd_sem$cl == clst & all_mean_sd_sem$cnb == cnb)]/sqrt(length(which(subset_with_clusters_AG_unmatched$Hydra_k2 == meas)))
    all_mean_sd_sem$sem[which(all_mean_sd_sem$cl == clst & all_mean_sd_sem$cnb == cnb)] <- all_mean_sd_sem$sd[which(all_mean_sd_sem$cl == clst & all_mean_sd_sem$cnb == cnb)]/sqrt(nrow(subset_with_clusters_AG_unmatched))
  }
}
