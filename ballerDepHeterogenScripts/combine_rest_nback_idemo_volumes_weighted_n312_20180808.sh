...
outputdir=$(ls -d $datadir/for_cwasmdmr_concat_4mm/weighted_n312_fslstats)
...
for b  in $bblid;  do 
     ...
     echo "$imagelist" >> $datadir/subject_lists/subj_list_concat_weighted_IMAGELIST_n312.txt
done
