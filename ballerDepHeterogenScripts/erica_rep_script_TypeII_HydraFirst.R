#Anova() from the car package will compute the Type II SS ANOVA tests, which report effects controlling for all othe effects in the model. So order of variables doesn't matter.
