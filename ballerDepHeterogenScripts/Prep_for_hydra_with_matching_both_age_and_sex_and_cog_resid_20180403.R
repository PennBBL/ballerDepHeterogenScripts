...
#write.csv(subset_bblidAndCog_features, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_matched_age_and_z_resid/CogFeatures.csv", row.names = FALSE, quote = FALSE)
#write.csv(subset_bblidAndCovariates, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_matched_age_and_z_resid/CogCovariates.csv", row.names = FALSE, quote = FALSE)
...
#ps.model =gam(dep_binarized ~s(age_in_years), data=dataset, family=binomial)
...
m.out <-matchit(dep_binarized ~ age_in_years + sex, data=dataset, method="nearest", distance="mahalanobis")
...
saveRDS(data.matched, file='/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_matched_age_sex_and_z_resid/Matched_age_20180403_matched.rds')
...
write.csv(for_hydra_data.matched_features, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_matched_age_sex_and_z_resid/CogFeatures.csv", row.names = FALSE, quote = FALSE)
write.csv(for_hydra_data.matched_cov, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_matched_age_sex_and_z_resid/CogCovariates.csv", row.names = FALSE, quote = FALSE)
