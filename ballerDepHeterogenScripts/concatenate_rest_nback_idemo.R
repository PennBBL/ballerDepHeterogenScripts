...
get_sample_net_rest_task <- function(sample,parcellation) {
  ...
  save_file_path <- paste0('/data/jux/BBL/projects/ballerDepHeterogen/results/output_of_fc/concatenate_rest_nback_idemo/indiv_subj_concat_text_files/',num_sub,'_',parcellation,'_rest_task_net.RData')
