...
saveRDS(data.matched, file='/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_matched_age_and_z_resid/Matched_age_20180403_matched.rds')
...
write.csv(for_hydra_data.matched_features, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_matched_age_and_z_resid/CogFeatures.csv", row.names = FALSE, quote = FALSE)
write.csv(for_hydra_data.matched_cov, file="/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/hydra_matched_age_and_z_resid/CogCovariates.csv", row.names = FALSE, quote = FALSE)
