---
title: "Master Replicated 04172019, covaried for medu and race"
author: "Erica Baller"
date: "4/16/2019"
output:
...
{
  lm(substitute(i ~ medu1 + race_binarized + Hydra_k3, list(i = as.name(x))), data = subset_with_clusters_matched)
})
...
{
  lm(substitute(i ~ medu1 + race_binarized +  nbackRelMeanRMSMotion + Hydra_k3, list(i = as.name(parcellation))), data = subset_with_clusters_matched)
})
...
###################################################
#Look at model summaries
models_anova_lm_agesq <- lapply(parcellation_cluster_stats_anova_matched, summary)

#Pull p-values
p_anova_lm_agesq <- sapply(parcellation_cluster_stats_anova_matched, function(v) v$"Pr(>F)"[4]) 
f_anova_lm_agesq <- sapply(parcellation_cluster_stats_anova_matched, function(v) v$"F value"[4])
...
#write csv for caret
#write.table(pfdr_anova_lm_agesq, '/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/nback_fdr_corr_12rois_taskactive.csv', col.names = FALSE, quote=FALSE, sep=",")

#write.table(fs_fdr_corrected_with0s$f_anova_lm_agesq,'/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/nback_f_fdr_corr0s_12rois_task_active.csv', col.names = FALSE, quote=FALSE, sep=",")

#write.table(fs_fdr_corrected, '/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/nback_f_fdr_corr_12rois_task_active.csv', col.names = FALSE, quote=FALSE, sep=",", row.names = FALSE)

#also include zeros for task_deactive areas
#write.table(c(fs_fdr_corrected_with0s$f_anova_lm_agesq, rep(0,6)), '/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/nback_f_fdr_corr0s_12rois_fromFull27set.csv', col.names = FALSE, quote=FALSE, sep=",")
...
#write.csv(all_mean_sd_sem, "/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/all_mean_sd_sem_nback_unsorted_12task_active.csv")

#new order sorted from least % signal change to most % signal change
new_order <- read.csv("/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/all_mean_sd_sem_nback_sorted_12task_active.csv")
