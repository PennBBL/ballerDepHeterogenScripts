---
title: "Cog_hydra_results_unmatched_resid_Hydra_k2"
author: "Erica Baller"
date: "4/3/2018"
output:
...
#Chi squared sex - significance p = 7.305x 10^-19
...
ggplot(dat_sex_race_no_significance, aes(x = cl, y = percent_males, fill=cl)) + geom_col() +
  ...
  ggtitle("Hydra_k2 % Male, p = 7.305e-19") + scale_fill_discrete(breaks=c("TD", "Cluster1", "Cluster2")) +
...
ggplot(dat_sex_race_no_significance, aes(x = cl, y = percent_caucasian, fill=cl)) + geom_col() + 
  ...
  ggtitle("Hydra_k2 % Caucasian, p = 7.494e-7") + scale_fill_discrete(breaks=c("TD", "Cluster1", "Cluster2")) + 
  guides(fill=guide_legend(title=NULL))
...
#dat_age_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2", "Cluster3"), age = c(mean(subset_with_clusters_AG_resid$age_in_years[which(subset_with_clusters_AG_resid$Hydra_k2 ==-1)]), mean(subset_with_clusters_AG_resid$age_in_years[which(subset_with_clusters_AG_resid$Hydra_k2 ==1)]), mean(subset_with_clusters_AG_resid$age_in_years[which(subset_with_clusters_AG_resid$Hydra_k2 ==2)]), mean(subset_with_clusters_AG_resid$age_in_years[which(subset_with_clusters_AG_resid$Hydra_k2 ==3)])), age_sd = c(sd(subset_with_clusters_AG_resid$age_in_years[which(subset_with_clusters_AG_resid$Hydra_k2 ==-1)]), sd(subset_with_clusters_AG_resid$age_in_years[which(subset_with_clusters_AG_resid$Hydra_k2 ==1)]), sd(subset_with_clusters_AG_resid$age_in_years[which(subset_with_clusters_AG_resid$Hydra_k2 ==2)]), sd(subset_with_clusters_AG_resid$age_in_years[which(subset_with_clusters_AG_resid$Hydra_k2 ==3)])))
...
#dat_medu_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2", "Cluster3"), medu = c(mean(subset_with_clusters_AG_resid$medu1[which(subset_with_clusters_AG_resid$Hydra_k2 ==-1)]), mean(subset_with_clusters_AG_resid$medu1[which(subset_with_clusters_AG_resid$Hydra_k2 ==1)]), mean(subset_with_clusters_AG_resid$medu1[which(subset_with_clusters_AG_resid$Hydra_k2 ==2)]), mean(subset_with_clusters_AG_resid$medu1[which(subset_with_clusters_AG_resid$Hydra_k2 ==3)])), age_sd = c(sd(subset_with_clusters_AG_resid$medu1[which(subset_with_clusters_AG_resid$Hydra_k2 ==-1)]), sd(subset_with_clusters_AG_resid$medu1[which(subset_with_clusters_AG_resid$Hydra_k2 ==1)]), sd(subset_with_clusters_AG_resid$medu1[which(subset_with_clusters_AG_resid$Hydra_k2 ==2)]), sd(subset_with_clusters_AG_resid$medu1[which(subset_with_clusters_AG_resid$Hydra_k2 ==3)])))
...
for(cnb in cnb_measure_names_list){
  for(num in 1:3) {
   ...
   # all_mean_sd_sem$sem[which(all_mean_sd_sem$cl == clst & all_mean_sd_sem$cnb == cnb)] <- all_mean_sd_sem$sd[which(all_mean_sd_sem$cl == clst & all_mean_sd_sem$cnb == cnb)]/sqrt(length(which(subset_with_clusters_AG_matched$Hydra_k2 == meas)))
...
ggplot(data = all_mean_sd_sem, aes(x = cnb, y = mean, group = cl)) +  ylab("Mean Z-score") +
  ...
  ggtitle("Hydra_k2, unmatched resid CNB Measures") 
...
ggplot(cnb_all_measures, aes(x = cl, y = acc, fill=cl)) + geom_col() +
  scale_x_discrete(limits=c("TD", "Cluster1", "Cluster2")) + xlab("Clusters") + ylab("Accuracy") + 
  ggtitle("Hydra_k2 Accuracy") + scale_fill_discrete(breaks=c("TD", "Cluster1", "Cluster2")) +
  guides(fill=guide_legend(title=NULL))

ggplot(cnb_all_measures, aes(x = cl, y = speed, fill=cl)) + geom_col() +
  scale_x_discrete(limits=c("TD", "Cluster1", "Cluster2")) + xlab("Clusters") + ylab("Speed") + 
  ggtitle("Hydra_k2 Processing Speed") + scale_fill_discrete(breaks=c("TD", "Cluster1", "Cluster2")) +
  guides(fill=guide_legend(title=NULL)) 

ggplot(cnb_all_measures, aes(x = cl, y = eff, fill=cl)) + geom_col() +
  scale_x_discrete(limits=c("TD", "Cluster1", "Cluster2")) + xlab("Clusters") + ylab("Efficiency") + 
  ggtitle("Hydra_k2 Efficiency") + scale_fill_discrete(breaks=c("TD", "Cluster1", "Cluster2")) +
  guides(fill=guide_legend(title=NULL))
