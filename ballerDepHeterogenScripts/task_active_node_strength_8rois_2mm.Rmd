---
title: "Node Strength, task active, matched age and sex, n312, Hydra K3, 8 jneurosci labels, 2mm"
author: "Erica Baller"
date: "02/06/2019"
output:
...
ggplot(all_mean_sd_sem_network, aes(x = cl, y = mean, fill = cl)) + geom_col() + 
    ...
    ggtitle(paste0("Network Strength by Cluster, P=0.043"))  #scale_fill_discrete(breaks=cl) +
    #guides(fill=guide_legend(title=NULL)) 
