---
title: "Functional connectivity, matched age and sex, n312, Hydra K3, 27 jneurosci labels edge analysis, 2mm"
author: "Erica Baller"
date: "02/05/2019"
output:
...
dem_and_cluster_data <- read.csv("/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/df_27roi_edge_analysis_20190130_2mm.csv")
...
parcellations <- names(subset_with_clusters_AG_matched[10:360])
...
row.names(anova_before_correction_p05) <- row.names(p_anova_lm_agesq)[p_anova_lm_agesq<0.05]
print(anova_before_correction_p05)
