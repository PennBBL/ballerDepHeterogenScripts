---
title: "Cognitive data hydra results <MATCH_TYPE> <FEATURE_MATCHED_ON> <N>, <COVARIANCE>"
author: "Erica Baller"
date: "4/23/2018"
output:
...
hydra_AG_matched_clusters <- read.csv("/Users/eballer/BBL/from_chead/ballerDepHeterogen/hydra_output_from_cbica/hydra_<match_type>/<covariance_type>/CogData_<matched_type>_<FEATURE_MATCHED_ON>_n<N>_<COVARIANCE>_HydraSubtypes.csv", header = TRUE, sep = ",")
#hydra_AG_matched_clusters <- read.csv("/Users/eballer/BBL/from_chead/ballerDepHeterogen/hydra_output_from_cbica/hydra_matched/no_covariance/CogData_matched_all_n1424_no_resid_HydraSubtypes.csv", header = TRUE, sep = ",")
