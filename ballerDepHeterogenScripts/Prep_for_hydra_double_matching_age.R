...
#sex
string_to_eval_cov <- paste("data.frame(", short, "data_age[1], ", short, "data_age[2])", sep = "")
subset_bblidAndCog_cov <- eval(parse(text = as.name(string_to_eval_cov)))
...
#medu
string_to_eval_cov <- paste("data.frame(", short, "data_age[1], ", short, "data_age[10])", sep = "")
subset_bblidAndCog_cov <- eval(parse(text = as.name(string_to_eval_cov)))
...
#race
string_to_eval_cov <- paste("data.frame(", short, "data_age[1], ", short, "data_age[80])", sep = "")
subset_bblidAndCog_cov <- eval(parse(text = as.name(string_to_eval_cov)))
