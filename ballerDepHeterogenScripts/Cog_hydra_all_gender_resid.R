...
CNB_cog_score_cluster_stats_lm_AG_resid_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  CNB_cog_score_cluster_stats_lm_AG_resid_withincluster<- lapply(cnb_measure_names_list, cluster=as.name(cluster_name), function(cnb_measure_name, cluster) 
  {
    cnb_measure <- as.name(cnb_measure_name)
    lm(substitute(cnb_measure ~ cluster, list(cnb_measure = cnb_measure, cluster = cluster)), data = subset_with_clusters_AG_resid)
  })
  setNames(CNB_cog_score_cluster_stats_lm_AG_resid_withincluster, cnb_measure_names_list)
})
names(CNB_cog_score_cluster_stats_lm_AG_resid_by_cluster_1through10) <- cluster_names_list
...
CNB_cog_score_cluster_stats_anova_AG_resid_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  ...
  {
    cnb_measure <- as.name(cnb_measure_name)
    anova(lm(substitute(cnb_measure ~ cluster, list(cnb_measure = cnb_measure, cluster = cluster)), data = subset_with_clusters_AG_resid))
  })
  setNames(CNB_cog_score_cluster_stats_anova_AG_withincluster, cnb_measure_names_list)
})
names(CNB_cog_score_cluster_stats_anova_AG_resid_by_cluster_1through10) <- cluster_names_list
...
df_mean_accuracy_z <-c(mean(subset_with_clusters_AG_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_resid$Hydra_k2 == -1)]),
                       mean(subset_with_clusters_AG_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_resid$Hydra_k2 == 1)]),
                       mean(subset_with_clusters_AG_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_resid$Hydra_k2 == 2)]))

df_mean_processing_speed_z <- c(mean(subset_with_clusters_AG_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_resid$Hydra_k2 == -1)]),
                                mean(subset_with_clusters_AG_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_resid$Hydra_k2 == 1)]),
                                mean(subset_with_clusters_AG_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_resid$Hydra_k2 == 2)]))

df_mean_efficiency_z <- c(mean(subset_with_clusters_AG_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_resid$Hydra_k2 == -1)]),
                          mean(subset_with_clusters_AG_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_resid$Hydra_k2 == 1)]),
                          mean(subset_with_clusters_AG_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_resid$Hydra_k2 == 2)]))
...
cnb_data_acc_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2"), mean_acc = c(mean(subset_with_clusters_AG_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_resid$Hydra_k2 ==-1)]),
                                                                                     mean(subset_with_clusters_AG_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_resid$Hydra_k2 ==1)]),
                                                                                     mean(subset_with_clusters_AG_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_resid$Hydra_k2 ==2)])),
                                  sd_acc = c(sd(subset_with_clusters_AG_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_resid$Hydra_k2 == -1)]),
                                             sd(subset_with_clusters_AG_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_resid$Hydra_k2 ==1)]),
                                             sd(subset_with_clusters_AG_resid$NAR_Overall_Accuracy[which(subset_with_clusters_AG_resid$Hydra_k2 ==2)])))

cnb_data_speed_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2"), mean_speed = c(mean(subset_with_clusters_AG_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_resid$Hydra_k2 ==-1)]),
                                                                                         mean(subset_with_clusters_AG_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_resid$Hydra_k2 ==1)]),
                                                                                         mean(subset_with_clusters_AG_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_resid$Hydra_k2 ==2)])),
                                    sd_speed = c(sd(subset_with_clusters_AG_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_resid$Hydra_k2 == -1)]),
                                                 sd(subset_with_clusters_AG_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_resid$Hydra_k2 ==1)]),
                                                 sd(subset_with_clusters_AG_resid$NAR_Overall_Speed[which(subset_with_clusters_AG_resid$Hydra_k2 ==2)])))

cnb_data_eff_sd_sem <- data.frame(cl = c("TD", "Cluster1", "Cluster2"), mean_eff = c(mean(subset_with_clusters_AG_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_resid$Hydra_k2 ==-1)]),
                                                                                     mean(subset_with_clusters_AG_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_resid$Hydra_k2 ==1)]),
                                                                                     mean(subset_with_clusters_AG_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_resid$Hydra_k2 ==2)])),
                                  sd_eff = c(sd(subset_with_clusters_AG_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_resid$Hydra_k2 == -1)]),
                                             sd(subset_with_clusters_AG_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_resid$Hydra_k2 ==1)]),
                                             sd(subset_with_clusters_AG_resid$NAR_Overall_Efficiency[which(subset_with_clusters_AG_resid$Hydra_k2 ==2)])))


cnb_data_acc_sd_sem$sem = cnb_data_acc_sd_sem$sd_acc/sqrt(nrow(subset_with_clusters_AG_resid))
cnb_data_speed_sd_sem$sem = cnb_data_speed_sd_sem$sd_speed/sqrt(nrow(subset_with_clusters_AG_resid))
cnb_data_eff_sd_sem$sem = cnb_data_eff_sd_sem$sd_eff/sqrt(nrow(subset_with_clusters_AG_resid))
...
###chisq_resid_sex <- chisq.test(subset_with_clusters_AG_resid$sex, (subset_with_clusters_AG_resid$Hydra_k2 != -1))
chisq_resid_sex <- chisq.test(subset_with_clusters_AG_resid$sex, subset_with_clusters_AG_resid$Hydra_k2)
chisq_resid_sex_pvalue <- chisq_resid_sex$p.value
...
chisq_resid_race <- chisq.test(subset_with_clusters_AG_resid$race_binarized, subset_with_clusters_AG_resid$Hydra_k2)
chisq_resid_race_pvalue <- chisq_resid_race$p.value
...
p_values <- c("", chisq_resid_sex_pvalue, "", chisq_resid_race_pvalue)
dat_sex_race <- data.frame(cl = c("TD", "Cluster1", "Cluster2", "Significance"), 
                           num_males = c(num_men_all_clusters, "---"),
                           percent_males = round(c(percent_men_all_clusters, chisq_resid_sex_pvalue), 2), 
                           num_caucasians = c(num_caucasian_all_clusters, "---"),
                           percent_caucasian = round(c(percent_caucasian_all_clusters, chisq_resid_race_pvalue),2))
...
# labs(x='Clusters_resid',y='') + scale_x_discrete(limits=c("TD", "Cluster1", "Cluster2", "Cluster3")) 
...
models_anova <- lapply(CNB_cog_score_cluster_stats_anova_AG_resid, summary)

#Pull p-values
p_anova <- sapply(CNB_cog_score_cluster_stats_anova_AG_resid, function(v) v$"Pr(>F)"[1]) #$coef[,"Pr(>F)"][2]) #get the p value for dep binarized
