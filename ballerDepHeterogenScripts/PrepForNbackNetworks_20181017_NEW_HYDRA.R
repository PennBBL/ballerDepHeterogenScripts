...
saveRDS(object = subset_with_clusters_AG_matched, file = "/Users/eballer/BBL/from_chead/ballerDepHeterogen/ballerDepHeterogenScripts/PrepForFunctionalNetworks/subset_with_T1_FC_and_dem_with_clusters_NEW_HYDRA.rds")

#save as csv, both the whole thing and JUST BBLID and SCANID
write.table(x = subset_with_clusters_AG_matched, file = "/Users/eballer/BBL/from_chead/ballerDepHeterogen/ballerDepHeterogenScripts/PrepForFunctionalNetworks/subset_with_T1_NbackFC_and_dem_with_clusters_NEW_HYDRA.csv", quote = FALSE, sep = " ")
write.table(x = cbind(subset_with_clusters_AG_matched$bblid, subset_with_clusters_AG_matched$scanid), file = "/Users/eballer/BBL/from_chead/ballerDepHeterogen/ballerDepHeterogenScripts/PrepForFunctionalNetworks/subset_with_T1_NbackFC_and_dem_with_clusters_justBBLID_and_SCANID_NEW_HYDRA.csv", quote = FALSE, sep = " ", col.names = FALSE, row.names = FALSE)
write.table(x = subset_with_clusters_AG_matched$scanid, file = "/Users/eballer/BBL/from_chead/ballerDepHeterogen/ballerDepHeterogenScripts/PrepForFunctionalNetworks/subset_with_T1_NbackFC_and_dem_with_clusters_justSCANID_NEW_HYDRA.csv", quote = FALSE, sep = " ", col.names = FALSE, row.names = FALSE)
write.table(x = subset_with_clusters_AG_matched$bblid, file = "/Users/eballer/BBL/from_chead/ballerDepHeterogen/ballerDepHeterogenScripts/PrepForFunctionalNetworks/subset_with_T1_NbackFC_and_dem_with_clusters_justBBLID_NEW_HYDRA.csv", quote = FALSE, sep = " ", col.names = FALSE, row.names = FALSE)

#write tables for each of the scanid data frames
write.table(x = scanid_TD, file = "/Users/eballer/BBL/from_chead/ballerDepHeterogen/ballerDepHeterogenScripts/PrepForFunctionalNetworks/nback_just_scanid_TD_n200_NEW_HYDRA.csv", quote = FALSE, sep = " ", col.names = FALSE, row.names = FALSE)
write.table(x = scanid_cluster1, file = "/Users/eballer/BBL/from_chead/ballerDepHeterogen/ballerDepHeterogenScripts/PrepForFunctionalNetworks/nback_just_scanid_cluster1_n60_NEW_HYDRA.csv", quote = FALSE, sep = " ", col.names = FALSE, row.names = FALSE)
write.table(x = scanid_cluster2, file = "/Users/eballer/BBL/from_chead/ballerDepHeterogen/ballerDepHeterogenScripts/PrepForFunctionalNetworks/nback_just_scanid_cluster2_n51_NEW_HYDRA.csv", quote = FALSE, sep = " ", col.names = FALSE, row.names = FALSE)
write.table(x = scanid_cluster3, file = "/Users/eballer/BBL/from_chead/ballerDepHeterogen/ballerDepHeterogenScripts/PrepForFunctionalNetworks/nback_just_scanid_cluster3_n57_NEW_HYDRA.csv", quote = FALSE, sep = " ", col.names = FALSE, row.names = FALSE)
