...
volume_score_cluster_stats_anova_lm_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
...
names(volume_score_cluster_stats_anova_lm_AG_matched_by_cluster_1through10) <- cluster_names_list
