...
volume_score_cluster_stats_gam_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
 ...
 {
    volume_measure <- as.name(volume_measure_name)
    gam(substitute(volume_measure ~ cluster + sex + s(age_in_years), list(volume_measure = volume_measure, cluster = cluster)), data = subset_with_clusters_AG_matched)
  })
...
volume_score_cluster_stats_lm_agesq_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  ...
  {
    volume_measure <- as.name(volume_measure_name)
    lm(substitute(volume_measure ~ cluster + sex + ageSq , list(volume_measure = volume_measure, cluster = cluster)), data = subset_with_clusters_AG_matched)
  })
...
volume_score_cluster_stats_gam_AG_matched <- lapply(volume_measure_names, function(x) 
{
  ...
  gam(substitute(volume_measure ~ Hydra_k3 + sex + s(age_in_years) , list(volume_measure = volume_measure)), data = subset_with_clusters_AG_matched)
})
...
{
  lm(substitute(i ~ Hydra_k3 + sex + ageSq , list(i = as.name(x))), data = subset_with_clusters_AG_matched)
})
...
volume_score_cluster_stats_anova_gam_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  ...
  {
     volume_measure <- as.name(volume_measure_name)
     anova(gam(substitute(volume_measure ~ cluster + sex + s(age_in_years) , list(volume_measure = volume_measure, cluster = cluster)), data = subset_with_clusters_AG_matched))
  })
...
volume_score_cluster_stats_anova_lm_agesq_AG_matched_by_cluster_1through10 <- lapply(cluster_names_list, function(cluster_name)
{
  ...
  {
     volume_measure <- as.name(volume_measure_name)
     anova(lm(substitute(volume_measure ~ cluster + sex + ageSq , list(volume_measure = volume_measure, cluster = cluster)), data = subset_with_clusters_AG_matched))
  })
