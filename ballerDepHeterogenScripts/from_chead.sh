#!/bin/bash
#this script is required to concatenate all the scans before MDMR
...
if (( "$#" < 4)); then
        ...
        echo "Please enter 4 pieces of information on the command line: <Option> <BBLID file> <SCANID file> <OUTPUT DIR>"
