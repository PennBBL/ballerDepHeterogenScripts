---
title: "Master Replicated 04052019"
author: "Erica Baller"
date: "4/5/2019"
output:
...
#Pull p-values
p_anova_lm_agesq <- sapply(parcellation_cluster_stats_anova_matched, function(v) v$"Pr(>F)"[2]) 
f_anova_lm_agesq <- sapply(parcellation_cluster_stats_anova_matched, function(v) v$"F value"[2])
...
#write csv for caret
write.table(pfdr_anova_lm_agesq, '/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/nback_fdr_corr_6rois_taskactive.csv', col.names = FALSE, quote=FALSE, sep=",")

write.table(fs_fdr_corrected_with0s$f_anova_lm_agesq,'/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/nback_f_fdr_corr0s_6rois_task_active.csv', col.names = FALSE, quote=FALSE, sep=",")
...
write.table(c(fs_fdr_corrected_with0s$f_anova_lm_agesq, rep(0,6)), '/Users/eballer/BBL/from_chead/ballerDepHeterogen/results/csvs/nback_f_fdr_corr0s_6rois_fromFull27set.csv', col.names = FALSE, quote=FALSE, sep=",")
