...
Part 4 : LM/GAM/LM with Agesq
  -The script then runs LM on each cognitive score (network ~ hydra_group). 
   - Does gam (network ~ hydra_group + s(age) + sex + averageManualRating + restRelMeanRMSMotion)
   - Does LM with ageSq (network ~ hydra_group + ageSq + sex + averageManualRating + restRelMeanRMSMotion)
