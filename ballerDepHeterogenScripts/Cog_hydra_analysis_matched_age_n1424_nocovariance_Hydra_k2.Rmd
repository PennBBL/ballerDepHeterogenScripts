---
title: "Cognitive data hydra results matched all (age, sex, medu, race) n1424, no covariance"
author: "Erica Baller"
date: "4/23/2018"
output:
...
ggplot(data = all_mean_sd_sem, aes(x = cnb, y = mean, group = cl)) +  ylab("Mean Z-score") +
  ...
  ggtitle("Hydra_k2, matched all (age, sex, medu, race), no residualizing, by CNB Measures")
