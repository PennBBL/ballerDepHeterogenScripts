...
outputdir=$(ls -d $datadir/for_cwasmdmr_concat_4mm/weighted_n312_rest_nback_idemo_tr_20181218)
images="subj_list_rest_nback_idemo_tr_weighted_IMAGELIST_n312.txt"
