---
title: "Functional Connectivity, Absolute removal, concatenated files(rest+nback+idemo), r400, com17 communities, n 325, Hydra_k3 within/between"
author: "Erica Baller"
date: "7/31/18"
output:
...
{
  network = as.name(network)
  gam(substitute(network ~ Hydra_k3 + sex + s(age_in_years) + restRelMeanRMSMotion, list(network = network)), data = subset_with_clusters_AG_matched_noTD)
})
