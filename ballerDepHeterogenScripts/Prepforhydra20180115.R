...
#subset of covariates (BBLID, sex, ageSq, race, age in years, maternal education), also do by males/females
subset_bblidAndCovariates <- data.frame(cbind(subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED[1:3], subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED[78:79], subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED[10]))
subset_bblidAndCovariates_males <- subset.data.frame(data.frame(cbind(subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED[1:3], subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED[78:79], subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED[10])), subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED$sex == 1)
subset_bblidAndCovariates_females <- subset.data.frame(data.frame(cbind(subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED[1:3], subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED[78:79], subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED[10])), subset_dep_or_no_psych_and_no_medicalratingExclude_DEPBINARIZED$sex == 2)
