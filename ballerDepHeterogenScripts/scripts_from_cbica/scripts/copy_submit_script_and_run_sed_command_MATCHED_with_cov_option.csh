...
if ($#argv < 3) then
   ...
   echo "Please enter a list, number (0 for no resids, 1 for resids BEFORE match, 2 for resids AFTER matching, 3 for using hydra for covariance, or the name of the analysis you'd like to use ex <covaried_before_match>), and number of subjects"
else
	set list = $1
	if ($2 == 0) then
