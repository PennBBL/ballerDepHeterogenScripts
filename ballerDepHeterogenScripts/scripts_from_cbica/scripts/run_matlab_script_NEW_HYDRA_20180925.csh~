if ($#argv < 4) then
   ...
   echo "as of 9/25, for this script, you must provide a date, so that it can look at the appropriate replication file"
	...
	set replication_date = $4
        ...
        foreach x (`cat $list`)	 
		cp matlab_script_to_get_subtypes_and_ARI /cbica/projects/pncHeterogeneity/ballerDepHeterogen/results/${replication_date}_New_Hydra/CogData_${x}_n${num_subs}_${analysis}_replication_${replication_date}/.
